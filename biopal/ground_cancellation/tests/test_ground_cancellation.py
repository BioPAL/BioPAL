...
def test_ground_cancellation():
    ...
    ground_cancellation_1()
    ground_cancellation_2()
    

def ground_cancellation_1():
    """
...
def ground_cancellation_2():
    ...
    # converto to 2dMap, tio enable the space varying
