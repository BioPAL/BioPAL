...
class StackBasedProcessingFH(Task):
    ...
    def _run(self, input_file_xml):
        ...
        for stack_idx, (unique_stack_id, acquisitions_pf_names) in enumerate(
            ...
            logging.info(
                'Covariance Estimation Window Size used: {} [m]'.format(cov_est_window_size)
            )
            ...
            try:
                ...
                logging.error(
                    'FH: error during estimation quality layer evaluation: ' + str(e), exc_info=True
                )
                raise
            ...
            try:
                ...
                kz_and_valid_values_mask_ground_fname = os.path.join(
                    temp_output_folder_gr, 'kz_and_valid_values_mask_' + unique_stack_id + '.tif'
                )
            ...
            try:
                ...
                equi7_temp_mask_outdir = os.path.join(
                    temp_output_folder_e7, 'kz_and_valid_values_mask'
                )
